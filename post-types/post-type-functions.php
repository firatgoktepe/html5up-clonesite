...
function nax_register_post_type($cpt_name, $cpt_singular, $cpt_plural, $cpt_domain, $cpt_dashicon)
{
    register_post_type($cpt_name, array(
        ...
        'supports' => array('title', 'editor', 'thumbnail', 'excerpt', 'custom fields', 'author', 'page attributes', 'post formats'),
        'has_archive' => false,
        'rewrite' => true,
        'query_var' => true,
        'menu_position' => null,
...
// cpt_updated_messages($messages, 'News', 'news', 'html5up-1');
// cpt_updated_messages($messages, 'Cases', 'case', 'html5up-1');
