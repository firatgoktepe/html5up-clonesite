...
//     'labels' => [
//       'name'                  => __('news', 'html5up-1'),
//       'singular_name'         => __('News', 'html5up-1'),
//       'menu_name'             => __('News', 'html5up-1'),
//       'name_admin_bar'        => __('News', 'html5up-1'),
//       'add_new'               => __('Add New', 'html5up-1'),
//       'add_new_item'          => __('Add New News', 'html5up-1'),
//     ],
//     'public'            => false,
//     'show_ui'           => true,
//     'has_archive'       => false,
...
//     'labels' => [
//       'name'                  => __('cases', 'html5up-1'),
//       'singular_name'         => __('case', 'html5up-1'),
//       'menu_name'             => __('Cases', 'html5up-1'),
//       'name_admin_bar'        => __('case', 'html5up-1'),
//       'add_new'               => __('Add New', 'html5up-1'),
//       'add_new_item'          => __('Add New case', 'html5up-1'),
//     ],
//     'public'            => true,
//     'has_archive'       => true,
//     'rewrite'           => ['slug' => 'cases'],
...
//Limitation of default wp blocks
...
function naxtheme_scripts()
{
    ...
    //wp_enqueue_script('pagination-scripts', get_template_directory_uri() . '/src/js/infinity-paginator.js', array('jquery'));
...
/* Custimezed Latest Posts Widget */ 
